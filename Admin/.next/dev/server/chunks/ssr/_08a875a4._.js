...
"[project]/app/payments/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PaymentsPage() {
    ...
    const { totalRevenue, totalTokens, filteredPayments } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        const revenue = payments.reduce((sum, p)=>sum + p.amount, 0) / 100;
        const tokens = payments.reduce((sum, p)=>sum + p.tokens_purchased, 0);
        const filtered = payments.filter((p)=>p.user_name.toLowerCase().includes(searchQuery.toLowerCase()) || p.paystack_reference.toLowerCase().includes(searchQuery.toLowerCase()));
        return {
    ...
    const paginatedPayments = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
...
//# sourceMappingURL=_08a875a4._.js.map